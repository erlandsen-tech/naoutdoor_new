  ...
  return (
    <div className="w-full flex-1 relative min-h-[60vh]">
      <div className="max-w-5xl mx-auto px-4 py-6">
        <h2 className="text-center font-bold text-2xl mb-4">Ski trail map</h2>
        <div className="w-full overflow-auto">
          ...
          >
            <Image src="/img/skibakke.jpg" alt="Ski trail map" width={1600} height={1200} className="mx-auto h-auto w-full max-w-full cursor-zoom-in" />
          </button>
        </div>
        <div className="flex justify-center mt-6">
          <Link href="/ski-and-recovery">
      ...
      {open && (
        <ImageLightbox src="/img/skibakke.jpg" alt="Ski trail map" onClose={() => setOpen(false)} />
      )}
    </div>
  );
}
